...
If anything won't come online or behaves oddly, see [Troubleshooting]({{ site.baseurl }}/troubleshooting/). For service, replacements, or full specifications, see [Warranty & Service]({{ site.baseurl }}/warranty-service/).