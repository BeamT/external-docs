...
Send the old heater back to Focal using the return steps in [Warranty & Service]({{ site.baseurl }}/warranty-service/). If the new heater won't come online or the wrong unit responds, see [Troubleshooting]({{ site.baseurl }}/troubleshooting/).